...
function About() {
  return (
    ...
    >
      ...
      <p>
        Hello, I'm Kiran Giri, a passionate web developer with a keen eye for
        MERN stack. With a background in IT, I strive to create impacful and
        visually stunning software solutions that leave a lasting impressions.
      </p>
      <br />
      ...
      <span>
        [1-10Th] [BalBodh Higher Secondary School Kanchanpur-Saptari][2074], [+2]
        [GreenLand International Secondary School][2077], [BSc.CSIT][Aims College Biratnagar ] [2081], [Internships] [Sipalaya Info Tech Kathmandu] [2081]
      </span>
